...
components.fontOpenSans = {
	selector: 'html',
	styles: 'https://fonts.googleapis.com/css2?family=Open+Sans:wght@600&display=swap'
};
...
components.fontCormorant = {
	selector: 'html',
	styles: 'https://fonts.googleapis.com/css2?family=Cormorant:wght@400;500;600&display=swap'
};
...
components.gmap = {
	...
	script: [
		'//maps.google.com/maps/api/js?key=&libraries=geometry,places&v=quarterly',
